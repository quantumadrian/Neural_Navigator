...
# Virtual Consultation Page
    ...
    st.subheader("Virtual Consultation Page")
    st.write("Here is where the virtual consultation details will be displayed.")
    if st.button("⬅️ Back to Home"):
        st.session_state.page = "home"
        st.rerun()  # Rerun the app to go back to the home page
